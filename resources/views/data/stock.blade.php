                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number"
                                                class="form-control @error('lifetime') is-invalid @enderror" id="lifetime"
                                                name="lifetime" value="{{ old('lifetime') }}">
                                            @error('lifetime')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number"
                                                class="form-control @error('leadtime') is-invalid @enderror" id="leadtime"
                                                name="leadtime" value="{{ old('leadtime') }}">
                                            @error('leadtime')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number"
                                                class="form-control @error('stock_wrhs') is-invalid @enderror"
